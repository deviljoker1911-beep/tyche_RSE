...
fn derive_pd_curve(portfolio: &Portfolio, scenario: &MacroScenario) -> BTreeMap<String, f64> {
    ...
    for loan in &portfolio.loans {
        ...
        // Distance to default in units of asset volatility. Calibrated so that
        // a healthy 4.0x-leveraged credit at 30% asset vol prints around a
        // 1.5–2.0% 1y PD, consistent with mid-market direct-lending priors.
